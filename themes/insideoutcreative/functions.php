...
function the_nu_age_group_stylesheets() {
...
if(is_front_page() || is_page_template('templates/careers.php')){
...
// own carousel
// wp_enqueue_style('own-carousel-css-min', get_theme_file_uri('/own-carousel/own-carousel.min.css'));
// wp_enqueue_script('own-carousel-js', get_theme_file_uri('/own-carousel/own-carousel.min.js'));
// wp_enqueue_script('own-carousel-js-custom', get_theme_file_uri('/own-carousel/own-carousel.js'));
...
add_action('wp_enqueue_scripts', 'the_nu_age_group_stylesheets');
// for footer
function the_nu_age_group_stylesheets_footer() {
...
// 	wp_enqueue_script('jquery-min', get_theme_file_uri('/owl-carousel/jquery.min.js'));
	// wp_enqueue_script('owl-carousel', get_theme_file_uri('/owl-carousel/owl.carousel.min.js', true));
	// wp_enqueue_script('owl-carousel-custom', get_theme_file_uri('/owl-carousel/owl-carousels.js', true));
...
add_action('get_footer', 'the_nu_age_group_stylesheets_footer');
...
function the_nu_age_group_menus() {
...
add_action('after_setup_theme', 'the_nu_age_group_menus');
